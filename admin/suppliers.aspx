                   ...
                   <table style="width:570px;" border="0">       
                      <tr>
                          ...
                          <td style="width:50%;background-color:#ffffff;">
                              <center>
                                  <asp:DropDownList ID="DdlCategorys" CssClass="ddl"  runat="server" />                                  
                              </center>
                          </td>   
                      </tr>
                      <tr>
                   ...
                   <table style="width:570px;" border="0">       
                      ...
                      <tr>
                          ...
                          <td style="width:50%;background-color:#ffffff;">
                              <center>
                                <span class="at1">
                                    <asp:TextBox ID="TxtName2" runat="server" onkeyup="validationName()" />                             
                               </span>
                              </center>
                          </td> 
                      </tr>
                      <tr>
                         ...
                         <td style="width:50%;background-color:#ffffff;">
                             <center>
                                <span class="at1">
                                    <asp:TextBox ID="TxtPhone2" runat="server" onkeyup="validationPhone()" />                                 
                                </span>
                             </center>
                         </td> 
                      </tr>
                      <tr>
                          ...
                          <td style="width:50%;background-color:#ffffff;">
                              <center>
                                  <span class="at1">
                                   <asp:TextBox ID="TxtEmail2" runat="server" onkeyup="validationEmail()" />                                                                        
                                  </span>
                              </center>
                          </td> 
                      </tr>                                                                        
...
<script>
    ...
    function validationText2() {
        ...
        cat = document.getElementById('<%= DdlCategorys2.ClientID %>').value.trim();                                                    
            ...
            document.getElementById('<%= Hidden2.ClientID %>').value = cat
        }   
